      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-heading__title">联系我们</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="content col-md-12">
            ...
            <div class="card">
              ...
              <div class="card__content" style="text-align: center;">
				<img src="<%=root%>/images/soccer/soccer_team_contact_us/soccer_team_contact_us_01.jpg" alt="Banner">
				<img src="<%=root%>/images/soccer/soccer_team_contact_us/soccer_team_contact_us_02.jpg" alt="Banner">
              </div>
            </div>
            <!-- Game Scoreboard / End -->
