...
<%
	...
	String a = (String)request.getAttribute("type");
%>
...
var EnvConfig={
		...
		ATTACH_PATH:"<%=AttachDir.NEWSINFO%>",
		MANAGE_ITEM_URL:"<%=root%>/admin/newsInfo",
		LIST_URL: function(page){
			return "<%=root%>/admin/newsInfo?type=<%=a%>&page="+page;
		},
		MANAGE_ITEM_DELETE_URL:function(id){
			return "<%=root%>/admin/newsInfo/"+id;
		},
		MANAGE_ITEM_TYPE:"<%=a%>"
	};
</script>
...
<script type="text/javascript" src="<%=root%>/js/admin/news.js"></script>
<h2><%="1".equals(a)?"新闻列表":"新闻咨询" %></h2>
<div class="well">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					...
					<input type="text" style="display:none" name="type" id = "type" value="<%=a%>"/>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" id="ordNum" class="form-control" required="required" />
						</div>
					</div>
					<div class="form-group">
