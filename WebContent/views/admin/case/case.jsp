...
var EnvConfig={
		...
		ATTACH_PATH:"<%=AttachDir.CASEINFO%>",
		MANAGE_ITEM_URL:"<%=root%>/admin/caseInfo",
		LIST_URL: function(page){
			return "<%=root%>/admin/caseInfo?page="+page;
		},
		MANAGE_ITEM_DELETE_URL:function(id){
			return "<%=root%>/admin/caseInfo/"+id;
		},
		
		
		MANAGE_ITEM_SUB_URL:"<%=root%>/admin/caseImageInfo",
		LIST_SUB_URL: function(caseId){
			return "<%=root%>/admin/caseImageInfo?caseId="+caseId;
		},
		MANAGE_ITEM_SUB_DELETE_URL:function(id){
			return "<%=root%>/admin/caseImageInfo/"+id;
		}
	};
</script>
...
<script type="text/javascript" src="<%=root%>/js/admin/case.js"></script>
<h2>案例</h2>
<div class="well">
...
<!-- 新增、编辑 -->
<div class="modal fade" id="editModal" data-backdrop="true" tabindex="-1" role="dialog" aria-hidden="true" style="padding-top: 0.1em">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-lg-2">
							<input type="text" id="ord" class="form-control" required="required" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">简述</label>
						<div class="col-lg-10">
							<textarea rows="4" class="form-control" id="intro" required="required"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">描述</label>
						<div class="col-lg-10">
							<textarea rows="6" class="form-control" id="content" required="required"></textarea>
						</div>
					</div>
				</form>
			</div>
			<div style="padding-left: 45px">
				<label class="col-lg-2 control-label">案例图片</label>
				<a id="addImg" href="#">+增加</a>
			</div>
			<div  class="modal-body" id="imgListDiv" style="padding-left: 10%;">
				<!-- div class="input-group" name="imgDiv">
