...
var EnvConfig={
		...
		ATTACH_PATH:"<%=AttachDir.PORTALINFO%>",
		MANAGE_ITEM_URL:"<%=root%>/admin/portalInfo",
		LIST_URL: function(page){
			return "<%=root%>/admin/portalInfo?portalType=right&page="+page;
		},
		MANAGE_ITEM_DELETE_URL:function(id){
			return "<%=root%>/admin/portalInfo/"+id;
		}
	};
</script>
...
<script type="text/javascript" src="<%=root%>/js/admin/portalRight.js"></script>
<h2>右侧推荐</h2>
<div class="well">
	首页右侧部分2个推荐内容，向右按照由小到大依次排序。
...
<table class="table table-hover" id="list">
	...
	<tfoot>
		<tr>
			<td colspan="7" class="text-right" style="display:none;">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" id="portalName" class="form-control" required="required" inputName="名称" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">英文名称</label>
						<div class="col-lg-10">
							<input type="text" id="engText" class="form-control" required="required" inputName="英文名称" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">内容</label>
						<div class="col-lg-10">
							<textarea rows="10" class="form-control" id="contentText" required="required" inputName="内容"></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<div class="input-group" id="portalImage">
