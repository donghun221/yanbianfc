...
var EnvConfig={
		...
		LIST_URL: function(page){
			return "<%=root%>/admin/portalInfo?portalType=left&page="+page;
		},
...
<script type="text/javascript" src="<%=root%>/js/admin/portalLeft.js"></script>
<h2>业务领域</h2>
<div class="well">
	首页左侧部分“业务领域”下的4个标签对应内容，向右按照由小到大依次排序。
