...
var EnvConfig={
		...
		LIST_URL: function(page){
			return "<%=root%>/admin/empInfo?empType=big_guy&page="+page;
		},
...
<script type="text/javascript" src="<%=root%>/js/admin/empBigGuy.js"></script>
<h2>创始合伙人</h2>
<div class="well">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<textarea rows="10" class="form-control" id="contentText" required="required" inputName="介绍"></textarea>
						</div>
					</div>
