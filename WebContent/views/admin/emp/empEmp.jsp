...
var EnvConfig={
		...
		LIST_URL: function(page){
			return "<%=root%>/admin/empInfo?empType=emp&page="+page;
		},
...
<script type="text/javascript" src="<%=root%>/js/admin/empEmp.js"></script>
<h2>员工风采</h2>
<div class="well">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label">图片名称</label>
						<div class="col-lg-10">
